...
const Footer = () => {
  return (
    <footer className="absolute bottom-0 w-full h-[30vh] sm:h-[20vh] py-4 px-12 bg-[#232323]">
      <div className="container mx-auto flex flex-col md:flex-row justify-center sm:justify-between items-center ">
        ...
        <div className="flex items-center">
          <motion.h1 initial={{opacity:0, y:0}}
           ...
           className="lastli text-[14em] ml-[2em] sm:ml-[0em] text-[#ffffff80] w-[100%]">Fossil Watches<span>©</span></motion.h1>
