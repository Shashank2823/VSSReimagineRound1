...
//   return (
//     <>
//       <h1 className='text-[4.5em] absolute bottom-[1700%] sm:top-[-26%] left-[9%] sm:left-[30%] p-[4em] sm:p-[2em] text-slate-400'>
//         In The{' '}
//         <motion.span
...
//         className='videodiv w-full sm:h-screen bottom-[5540%]'
//       >
  ...
  return (
    <>
      <div className="relative">
        <h1 className="text-[4.5em] absolute bottom-[1700%] sm:top-[-26%] left-[9%] sm:left-[30%] p-[4em] sm:p-[2em] text-slate-400">
          ...
          <motion.span
            ...
            whileInView={{ y: -100, opacity: 1 }}
            transition={{ ease: 'easeInOut', duration: 1 }}
            className="spot text-[5em] sm:text-[2em] ml-6 text-gray-200"
          >
            Limelight
          </motion.span>
        </h1>
      ...
      <motion.div 
        ...
        whileInView={{ opacity: 1, x: 0, scale: 0.9 }} // Move to center and scale up
        transition={{ ease: 'easeInOut', duration: 1.5 }} // Define the transition properties
        className="videodiv w-full sm:h-screen h-[80vh]"
      >
        <video className="w-full h-full object-cover" autoPlay muted loop src={video}></video>
      </motion.div>
    </>
